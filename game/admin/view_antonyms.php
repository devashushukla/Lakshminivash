<?php
	...
	{
		$sel = "delete from antonyms where id='$_REQUEST[id]'";
        ...
        <?php if(isset($_SESSION['msg_done'])){msg_done();}if(isset($_SESSION['msg_notdone'])){msg_notdone();}?>
				<div class="bs-example4" data-example-id="contextual-table">
					<div class="form-group">
						...
						<div class="pull-left">
						<?php 
							$a = "select id from antonyms where id=(select COUNT(*)
							 from antonyms)";
                ...
                <table id="employee_data" class="footable display table table-striped table-bordered table-hover" cellspacing="0" width="100%" data-filter="#filter" data-filter-minimum="4" data-page-size="3" data-first-text="<<" data-next-text=">" data-previous-text="<" data-last-text=">>">
                  <thead>
                     <tr>
                        ...
                        <th>Word</th>
                        <th data-hide="phone, tablet">Antonyms</th>
                  ...
                  ?>
                     ...
                     <tr>
                         ...
                         <td><?php echo (ucfirst($data['antonyms']));?></td>
		                 ...
		                 <td> 
                 		 ...
                 		 <div class="modal fade" id="myModal<?php echo $data['id'];?>" role="dialog">
		                   ...
		                   <?php
		                     $res=mysql_query("select * from `antonyms` where `id`='$data[id]'");
                     		...
                     		<div class="modal-content">
                       			...
                       			<div class="modal-body">
			                         ...
			                         <table align="center">
			                           ...
			                           <tr>
			                              <th>Synonyms:</th>
			                              <td><?php echo (ucfirst($record['antonyms']));?>			             
			                              </td>
			                           </tr>			                           
			                           <tr>
			                              <th>Detail:</th>
			                              <td><?php echo (ucfirst($record['detail']));?>			             
			                              </td>
			                           </tr>
			                         </table>
                         			</p>
						 ...
						 <a href="add_antonyms.php?edit=<?php echo $data['id'];?>"><i class="glyphicon glyphicon-pencil back" aria-hidden="true"></i></a>		                 
